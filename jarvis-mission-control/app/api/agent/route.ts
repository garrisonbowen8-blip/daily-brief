...
const TOOLS: Anthropic.Tool[] = [
  ...
  },
  {
    ...
    description: "Run the two-stage market research pipeline: fetch live prices and news for all holdings, then synthesize into a spoken intelligence paragraph. Call when asked about the portfolio, market, stocks, or how investments are doing.",
    input_schema: { type: "object", properties: {}, additionalProperties: false },
  },
  {
    name: "get_portfolio",
    description: "Get raw portfolio data: equity value, positions, prices, P&L per position. Call when asked for specific stock prices or position details.",
    input_schema: { type: "object", properties: {}, additionalProperties: false },
  },
];
